...
export default function ServiceHere({ data }: Props) {
            ...
            <div className="container">
                <div className="Newshero_left">
                    ...
                    {widthwindow > 700 ? <div className="Newshero_left-btn">
                        <Link to='/services' className="Newshero_left-text">Поделится с друзями</Link>
                ...
                <div className="Newshero_right">
                    ...
                    <Link to='/services' className="ObjectsHero-tbn">Все услуги</Link>
