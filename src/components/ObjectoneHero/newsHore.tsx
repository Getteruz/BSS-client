...
export default function ObejctOnehero({ data }: Props) {
            ...
            <div className="container">
                <div className="Newshero_left">
                    ...
                    {widthwindow > 700 ? <div className="Newshero_left-btn">
                        <Link to='/object' className="Newshero_left-text">Поделится с друзями</Link>
                ...
                <div className="Newshero_right">
                    ...
                    <Link to='/object' className="ObjectsHero-tbn">Все объекты</Link>
